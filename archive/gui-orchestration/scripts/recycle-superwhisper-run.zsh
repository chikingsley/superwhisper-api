...
REPO="/Users/simonpeacocks/GitHub/superwhisper-api"
...
WORKERS_CLI="$REPO/.venv/bin/superwhisper-api-workers"
...

{
  ...
  pids=$(
    {
      ...
      pgrep -f "superwhisper-api-workers --job-dir $JOB_DIR --run-id $RUN_ID" || true
      pgrep -f "/Users/simonpeacocks/GitHub/superwhisper-api/.venv/bin/python3 .*superwhisper-api --paths-file .*$RUN_ID" || true
      pgrep -f "sudo .*superwhisper-api --paths-file .*$RUN_ID" || true
    } | sort -nu
  )
  ...
  /bin/ps -axo user,pid,stat,etime,%cpu,%mem,rss,command | /opt/homebrew/bin/rg '/Applications/superwhisper\.app/Contents/MacOS/superwhisper|superwhisper-api-workers --job-dir .*resume_20260520T122211Z|superwhisper-api --paths-file .*resume_20260520T122211Z' || true
