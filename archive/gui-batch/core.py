"""Core logic for GUI-orchestrated Superwhisper transcription.

Polls the local Superwhisper SQLite database for transcript rows written
when audio files are opened via the macOS GUI.
"""
...
from superwhisper_api.gui.models import Transcript
